...
! function(e) {
 ...
 o.js = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function(e, t) {
  var n = this,
      i = "function" == typeof e,
      r = function() {
  ...
  function s(e, t) {
   ...
   ("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.js[m] = t, y.removeChild(p), function i() {
  ...
  var p = n.createElement("script"),
      h = (a[m] ? d : o.base || "") + (f.js[m] || m) + ".js";
  return p.async = !0, p.charset = "utf-8", p.src = h + function() {
   var e = o.version === !0 ? o.v || (new Date).getTime() : o.version || "";
   return e ? "?v=" + e : ""
  }(), o.js[m] ? ! function g() {
   return ++v > 1e3 * o.timeout / 4 ? r(m + " is not a valid module") : void("string" == typeof o.js[m] && o.status[m] ? c() : setTimeout(g, 4))
  ...
  var t = this;
  e = e || {};
  for (var n in e) t[n] || t.js[n] ? r("模块名 " + n + " 已被占用") : t.js[n] = e[n];
  return t
